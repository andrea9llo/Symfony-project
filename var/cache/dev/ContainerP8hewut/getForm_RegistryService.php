...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\InvoiceRowsType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\InvoiceRowsType']) ? $this->services['AppBundle\\Form\\InvoiceRowsType'] : ($this->services['AppBundle\\Form\\InvoiceRowsType'] = new \AppBundle\Form\InvoiceRowsType())) && false ?: '_'};
}, 'AppBundle\\Form\\InvoiceType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\InvoiceType']) ? $this->services['AppBundle\\Form\\InvoiceType'] : ($this->services['AppBundle\\Form\\InvoiceType'] = new \AppBundle\Form\InvoiceType())) && false ?: '_'};
